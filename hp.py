...
def banner():
	...
	print("")
	print("%s\033[1;32m     ╔══════════════════════════════════════════╗"%(Z))
	print("%s\033[1;91m     ║%s  Author   : %sACTION-FIRE 033[1;91m         %s║"%(Z,B,M,Z))
	print("%s\033[1;91m     ║%s  Github   : github.com/ACTION-FIRE033[1;91m %s║"%(Z,B,Z))
	print("%s\033[1;91m     ║%s  Facebook : facebook.com/ft.alvi.18033[1;91m%s║"%(Z,B,Z))
	print("%s\033[1;91m     ║%s  Version  : %sV.3.0               033[1;91m %s║"%(Z,B,H,Z))
	print("%s\033[1;32m     ╚══════════════════════════════════════════╝"%(Z))
	print("")
